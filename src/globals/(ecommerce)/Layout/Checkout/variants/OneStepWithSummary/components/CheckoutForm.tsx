...
export const CheckoutForm = ({
  ...
  const shippingAddresses =
    user?.shippings && user?.shippings?.length > 0 ? user?.shippings : null;
  ...
  const [checkoutProducts, setCheckoutProducts] =
    useState<ProductWithFilledVariants[]>();
            ...
            <div className="mt-10 border-t border-gray-200 pt-10">
              ...
              <div className="mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
                ...
                {(wantsInvoice || isCompany) && (
                  <>
                    <h2 className="text-lg font-medium text-gray-900 sm:col-span-2">
                      {t("invoice-data")}
                    </h2>
                    <FormField
                      control={form.control}
