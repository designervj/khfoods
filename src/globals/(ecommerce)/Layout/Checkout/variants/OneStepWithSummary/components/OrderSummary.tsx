      ...
      <div className="mt-4 rounded-lg border border-gray-200 bg-white shadow-xs">
                        ...
                        quantity={
                          cart?.find(
                            (cartProduct) =>
                              ...
                              cartProduct.choosenVariantSlug ===
        ...
        <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
          <button
            type="submit"
            form="checkout-form"
            disabled={!products || products.length === 0 || isSubmitting}
            className="w-full rounded-md border border-transparent bg-main-600 px-4 py-3 text-base font-medium text-white shadow-xs hover:bg-main-700 focus:outline-hidden focus:ring-2 focus:ring-main-500 focus:ring-offset-2 focus:ring-offset-gray-50 disabled:bg-gray-400 disabled:cursor-not-allowed"
          >
